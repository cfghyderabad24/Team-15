...
import ProjectBudgetDistribution from '../pages/authorities/ProjectBudgetDistribution';
import TicketDashboard from '../pages/authorities/TicketDashboard';
...
const getUserRole = (email) => {
  if (email.endsWith('@admin.cry.org.in')) {
    ...
    return 'ngo';
  } else if (email.includes('@designation.cry.org.in')) {
      ...
      case 'higherAuthority':
        return (
          <>
            ...
            <Route path='/sendtickets' element={<TicketDashboard />} />

            <Route path='/budgetdist' element={<ProjectBudgetDistribution />} />
            <Route path='/calender' element={<Calender/>} />
